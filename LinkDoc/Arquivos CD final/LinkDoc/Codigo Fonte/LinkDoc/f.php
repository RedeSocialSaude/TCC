        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-fw fa-table"></i> �rea Informativa</a>
                    </li>
                    ...
                    <div class="input-group">
                      <ul class="media-list media-list-users list-group">
                          <li class="list-group-item">
                            <div class="media">
                              <a class="media-left" href="#">
                                <img class="media-object img-circle" src="foto.png">
                              </a>
                              <div class="media-body">
                                
                                <strong>Fernanda k</strong>
                          ...
                          <li class="list-group-item">
                            <div class="media">
                              <a class="media-left" href="#">
                                <img class="media-object img-circle" src="foto2.png">
                              </a>
                              <div class="media-body">
                                <strong>Dany Boy</strong>
                                <small>@dhg - Palo Alto</small>
                                <b style="padding-left:250px;">
                                <input type="checkbox">
                                <span class="custom-control-indicator"></span></b>
                              </div>
                            </div>
                          ...
                          <li class="list-group-item">
                            <div class="media">
                              <a class="media-left" href="#">
                                <img class="media-object img-circle" src="foto3.png">
                              </a>
                              <div class="media-body">
                                <strong>Muleque Piranha</strong>
                                <small>@mdo - DivinÃ³polis</small>
                                <b style="padding-left:190px;">
                                <input type="checkbox">
                                <span class="custom-control-indicator"></span></b>
                              </div>
                            </div>
